...
export function BookRow({
  ...
  return (
    <div className="rounded-2xl overflow-hidden border transition duration-200 ease-in-out hover:scale-105 w-full">
      {/* Cover */}
      <div className="relative h-40 not-only:mx-auto mt-0">
